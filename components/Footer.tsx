...
// menus
const menus = [
  { id: 1, name: "Expertises", path: "/expertises" },
  ...
  return (
    <div className="relative container mx-auto md:h-[60vh] py-5 md:py-0 md:pb-10">
      ...
      <div className="flex flex-col items-center justify-end w-full h-full py-10 space-y-5">
        <h2 className="md:text-7xl font-bold">Let's Get Hyped!</h2>
        {/* buttons  */}
        <div className="flex items-center gap-4">
          <button className="flex items-center gap-2 border border-gray-500 rounded-md p-1 text-sm text-shadow-2xs font-medium cursor-pointer">
            Mail ons direct
            <span className="bg-black text-white rounded p-1">
              <Mail className="w-4 h-4" />
            </span>
          </button>
          <button className="bg-[#F35226] flex items-center gap-2 rounded-md p-1 text-sm text-shadow-2xs font-medium cursor-pointer text-white">
            Get Results
            <div className="bg-white p-1 rounded-md">
              <svg
                ...
                viewBox="0 0 20 24"
                fill="none"
                className="icon-18px w-4 h-4 text-orange-600"
              >
                <path
      ...
      {/* footer logo  */}
      <div className="hidden md:block absolute right-5 top-72 w-40 h-40 z-50">
        <Image
          src={footerLogo}
          width={100}
          height={100}
        ...
        <div className="md:flex flex-wrap items-center justify-between gap-10">
          ...
          <div>
            <div>
              ...
              <span className="text-xs">info@gmail.com</span>
              <span className="text-xs">+020202022020</span>
            </div>
            {/* addres  */}
            <div>
              <h2 className="text-sm font-semibold">Address</h2>
              <span className="text-xs">city </span>
              <span className="text-xs">63, west </span>
            </div>
          </div>
        </div>
      </div>
